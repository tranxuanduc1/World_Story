...
val COL_SCORE="score"
class DucDatabaseHelper(var context: Context): SQLiteOpenHelper(context,DATABASE_NAME,null,1) {
...
//                val isComic = cursor.getInt(cursor.getColumnIndexOrThrow("$COL_IS_COMIC"))
