 ...
 * Use the [Duc_ReadBookStories_Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class Duc_ReadBookStories_Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        storyViewModel.storiesHistory.observe(viewLifecycleOwner, Observer { stories ->
            ...
            if(stories.isNullOrEmpty()){
                binding.txtStoryNotFoundReadBookStoryFragment.visibility= View.VISIBLE
            }else{
                binding.txtStoryNotFoundReadBookStoryFragment.visibility= View.GONE
    ...
    companion object {
         ...
         * @return A new instance of fragment ReadBookStoriesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Duc_ReadBookStories_Fragment().apply {
